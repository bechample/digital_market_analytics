#!/usr/bin/env python3
"""
Shared utilities for Gumroad data collection.
...
GUMROAD_HOST = "gumroad.com"
BASE = f"https://{GUMROAD_HOST}"
...
def normalize_url(u: str) -> str:
    """Normalize URLs by stripping fragments and normalizing scheme/host to gumroad.com.

    - Forces https scheme and netloc gumroad.com for deduplication
    - Strips fragment
...
def is_allowed_host(host: str) -> bool:
    """Return True if host is gumroad.com or any of its subdomains."""
    if not host:
        return False
    h = host.lower()
    return h == GUMROAD_HOST or h.endswith("." + GUMROAD_HOST)
